...
**Laravel 5-6 example** is a tutorial application.

### Installation ###

* type `git clone https://github.com/praveenjee/learnlaravel.git` to clone the repository 
* type `cd projectname`
...
* Users roles : administrator (all access) and user (create comment in blog)
...
* Administrator : email = xxxxxx@xxx.com, password = xxxx 
* User : create new use with email and password
