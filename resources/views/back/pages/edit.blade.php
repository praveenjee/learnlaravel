   ...
   <div class="">
      ...
      <div class="row">
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="x_panel">
            <div class="x_title">
              <h2>Edit Page <small>{{ 'Please enter all the information here.' }}</small></h2>
            ...
            <div class="x_content">
              <br />
              <form name="frmAddPage" class="form-horizontal form-label-left" method="POST" action="{{ route('pages.update', [$page->id]) }}" enctype="multipart/form-data" data-parsley-validate>
              {{ csrf_field() }}
              {{ method_field('PUT') }}
                <div class="form-group">
                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="title">Page Title <span class="required">*</span></label>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="title" name="title" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('title', $page->title) }}" placeholder="Post Title">
                  </div>
                </div>                   
                ...
                <div class="form-group" style="display: none;">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" value="{{ old('slug', $page->slug) }}" name="slug" id="slug" class="form-control required" placeholder="Page Slug">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="meta_title" name="meta_title" class="form-control col-md-7 col-xs-12" value="{{ old('meta_title', $page->meta_title) }}" placeholder="Meta Title">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="meta_keyword" name="meta_keyword" class="form-control col-md-7 col-xs-12" value="{{ old('meta_keyword', $page->meta_keyword) }}" placeholder="Meta Keyword">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12">
                    <input type="text" id="meta_description" name="meta_description" class="form-control col-md-7 col-xs-12" value="{{ old('meta_description', $page->meta_description) }}" placeholder="Meta Description">
                  </div>
                </div>
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-6 col-sm-6 col-xs-12" style="padding-top:7px;">
                    <input type="radio" class="flat" name="status" id="status1" value="1" required="" data-parsley-multiple="status" style="position: absolute; opacity: 0;" {{ ($page->status == 1) ? 'checked="checked"' : "" }} > Active
                    
                    <input type="radio" class="flat" name="status" id="status0" value="0" required="" data-parsley-multiple="status" style="position: absolute; opacity: 0;" {{ ($page->status == 0) ? 'checked="checked"' : "" }} > Inactive
                  </div>
                </div>  
                ...
                <div class="form-group">
                  ...
                  <div class="col-md-8 col-sm-8 col-xs-12">
                    <textarea rows="3" cols="2" name="body" id="body" class="form-control required" placeholder="Page Content">{{ $page->body }}</textarea>
                  </div>
                </div>     
