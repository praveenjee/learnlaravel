         ...
         <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Add new Category <small>{{ 'Please enter all the information here.' }}</small></h2>
                  ...
                  <div class="x_content">
                    <br />
                    <form name="frmAddUser" class="form-horizontal form-label-left" method="POST" action="{{ url('admin/categories')}}" enctype="multipart/form-data" data-parsley-validate>
						        {{ csrf_field() }}
                      ...
                      <div class="form-group" style="display: none;">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="slug" name="slug" required="required" class="form-control col-md-7 col-xs-12" value="{{ old('slug') }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group">
                        <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                          <button type="submit" class="btn btn-primary">Save Category</button>
					                <a href="{{ URL::to('admin/categories') }}" class="btn btn-default" >Cancel </a>
                        </div>
                      </div>
