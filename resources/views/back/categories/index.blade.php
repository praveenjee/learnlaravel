  ...
  <div class="">
	...
	<div class="row">
	  <div class="col-md-12 col-sm-12 col-xs-12">
		<div class="x_panel">
		  <div class="x_title">
			<h2>View all Categories <small>Total no of Categories: {{$total}}</small></h2>
					...
					@if($total > 0)
						...
						<tr>
							...
							<td class="text-center">
								...
								@endif
								<a href="{{ URL::to('admin/categories/' . $category->id . '/edit') }}" title="Edit category">
									<i class="fa fa-pencil-square-o" aria-hidden="true"></i></a>&nbsp;
								<a href="javascript:delcategory({{$category->id}});" title="Delete category">
									<i class="fa fa-trash" aria-hidden="true"></i></a>
									
								<form action="{{url('admin/categories', [$category->id])}}" method="POST" id="frmDelCategory_{{$category->id}}">
	...
	<script>
		function delcategory(cid){
			if(confirm("Are you sure want to delete this category?")){
				document.getElementById("frmDelCategory_" + cid).submit();
			}
		}
	</script>
    <!-- iCheck -->
